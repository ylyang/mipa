...
public class TSCPApplication extends AbstractApplication {

	public TSCPApplication() {
		super();
	}
	...
	public void run() throws NotBoundException, IOException {
		...
		//while(true) {
			...
			if(input.trim().equals("1")) {
				...
				register("config/predicate/predicate_tscp.xml", onRegister, "tscp");
	...
	public static void main(String[] args) throws NotBoundException, IOException {
		TSCPApplication app = new TSCPApplication();
		app.run();
	}
}
